...
vim.api.nvim_set_keymap("i", "<C-t>",   "<Esc>:tabnew<CR>i",    { noremap = true, silent = false })
vim.api.nvim_set_keymap("i", "<C-l>",   "<Esc>:tabnext<CR>i",   { noremap = true, silent = false })
vim.api.nvim_set_keymap("i", "<C-h>",   "<Esc>:tabprev<CR>i",   { noremap = true, silent = false })
vim.api.nvim_set_keymap("n", "<C-h>",   "<Esc>:tabprev<CR>i",   { noremap = true, silent = false })
